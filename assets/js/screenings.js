...
const SCREENINGS = [
...

  {
    ...
    bands: [
      ...
      { max: 24, level: '중등도 우울감', tone: 'moderate',
        ...
        advice: 'PHQ-9 검사도 함께 해보시고, 결과가 비슷하다면 전문의 상담을 받아보세요.' },
...

  {
    ...
    toneText: {
      ...
      moderate: {
        ...
        advice: '가장 높게 나온 영역에 맞춰 개별 검사(PHQ-9·GAD-7·PSS-10)를 함께 해보시고, 결과가 비슷하다면 상담을 권합니다.' },
      high: {
  ...
  /* ═══════════════════════════════════════════════ 웰빙 · 생활 ════════ */
  {
    ...
    bands: [
      { max: 28, level: '웰빙 매우 저하', tone: 'severe',
        ...
        advice: 'PHQ-9 우울 검사를 함께 해보시고, 전문의 상담을 받아보시길 권합니다.' },
...

  {
    ...
    scale: 'AUDIT',
    tagline: '지난 1년간의 음주',
    blurb: '세계보건기구(WHO)가 만든 음주 문제 선별 검사입니다. 술이 스트레스 대처 수단이 되고 있는지 확인해 보세요.',
    minutes: 3,
    ...
    questions: [
      ...
      { text: '한 번에 소주 1병(또는 맥주 4캔) 이상 마시는 경우가 얼마나 자주 있습니까?', options: AUDIT_FREQ },
      { text: '지난 1년간, 술을 한번 마시기 시작하면 멈출 수 없었던 적이 얼마나 자주 있었습니까?', options: AUDIT_FREQ },
      { text: '지난 1년간, 술 때문에 일상적으로 해야 할 일을 하지 못한 적이 얼마나 있었습니까?', options: AUDIT_FREQ },
      { text: '지난 1년간, 과음한 다음 날 해장술을 마신 적이 얼마나 있었습니까?', options: AUDIT_FREQ },
      { text: '지난 1년간, 음주 후 죄책감이나 후회를 느낀 적이 얼마나 있었습니까?', options: AUDIT_FREQ },
      { text: '지난 1년간, 음주 때문에 전날 밤 일이 기억나지 않은 적이 얼마나 있었습니까?', options: AUDIT_FREQ },
      { text: '음주 때문에 자신이나 다른 사람이 다친 적이 있습니까?', options: AUDIT_YN },
      { text: '가족·친구·의사가 당신의 음주를 걱정하거나 술을 줄이라고 권한 적이 있습니까?', options: AUDIT_YN }
    ],
    bands: [
